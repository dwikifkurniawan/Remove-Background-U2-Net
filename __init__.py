...
# dir = "D:/coba/NG"
# dir = "D:/Soca AI/Research TMMIN/Converted/OK"
dir = "D:/coba/ban"
...
def removeBg(imagePath):
    ...
    unique_filename = os.path.basename(imagePath)
    ...
    image = image.type(torch.cuda.FloatTensor) if torch.cuda.is_available() else image.type(torch.FloatTensor)
...
for filename in os.scandir(dir):
    if filename.is_file():
        ...
        print(f"BG Removed: {itr} of {count}")
        itr += 1
...
# imgPath = "20230228_012939844_iOS.png"  # Change this to your image path
# print(removeBg(imgPath))
